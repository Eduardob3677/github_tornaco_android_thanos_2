.class public final Lkwyopc/kouubfr/sn8;
...
.field public final OooO0O0:Lkwyopc/kouubfr/on8;

.field public final OooO0OO:Ljava/util/LinkedHashMap;

.field public final OooO0Oo:Ljava/util/LinkedHashMap;

.field public OooO0o0:Lkwyopc/kouubfr/gd5;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Lkwyopc/kouubfr/qn8;->OooO00o(Landroid/content/Context;)Landroidx/window/sidecar/SidecarInterface;

    move-result-object p1

    new-instance v0, Lkwyopc/kouubfr/on8;

    invoke-direct {v0}, Lkwyopc/kouubfr/on8;-><init>()V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lkwyopc/kouubfr/sn8;->OooO00o:Landroidx/window/sidecar/SidecarInterface;

    iput-object v0, p0, Lkwyopc/kouubfr/sn8;->OooO0O0:Lkwyopc/kouubfr/on8;

    new-instance p1, Ljava/util/LinkedHashMap;

    invoke-direct {p1}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object p1, p0, Lkwyopc/kouubfr/sn8;->OooO0OO:Ljava/util/LinkedHashMap;
...
# virtual methods
.method public final OooO00o(Landroid/app/Activity;)Lkwyopc/kouubfr/xoa;
    .locals 2
    ...
    :cond_1
    iget-object v1, p0, Lkwyopc/kouubfr/sn8;->OooO00o:Landroidx/window/sidecar/SidecarInterface;
    ...
    :cond_2
    iget-object p1, p0, Lkwyopc/kouubfr/sn8;->OooO00o:Landroidx/window/sidecar/SidecarInterface;
    ...
    :cond_4
    iget-object v1, p0, Lkwyopc/kouubfr/sn8;->OooO0O0:Lkwyopc/kouubfr/on8;

    invoke-virtual {v1, v0, p1}, Lkwyopc/kouubfr/on8;->OooO0Oo(Landroidx/window/sidecar/SidecarWindowLayoutInfo;Landroidx/window/sidecar/SidecarDeviceState;)Lkwyopc/kouubfr/xoa;
...
.method public final OooO0O0(Landroid/app/Activity;)V
    ...
    :cond_1
    iget-object v2, p0, Lkwyopc/kouubfr/sn8;->OooO00o:Landroidx/window/sidecar/SidecarInterface;
    ...
    :cond_2
    iget-object v2, p0, Lkwyopc/kouubfr/sn8;->OooO0Oo:Ljava/util/LinkedHashMap;

    invoke-virtual {v2, p1}, Ljava/util/LinkedHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lkwyopc/kouubfr/pl1;
    ...
    :cond_3
    instance-of v4, p1, Lkwyopc/kouubfr/pa6;

    if-eqz v4, :cond_4

    move-object v4, p1

    check-cast v4, Lkwyopc/kouubfr/pa6;

    invoke-interface {v4, v3}, Lkwyopc/kouubfr/pa6;->OooO0o(Lkwyopc/kouubfr/pl1;)V

    :cond_4
    invoke-interface {v2, p1}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    :goto_1
    iget-object v2, p0, Lkwyopc/kouubfr/sn8;->OooO0o0:Lkwyopc/kouubfr/gd5;

    if-eqz v2, :cond_5

    iget-object v3, v2, Lkwyopc/kouubfr/gd5;->OooOOOO:Ljava/lang/Object;
    ...
    :cond_5
    :goto_2
    iget-object p1, p0, Lkwyopc/kouubfr/sn8;->OooO0OO:Ljava/util/LinkedHashMap;
...
.method public final OooO0OO(Landroid/os/IBinder;Landroid/app/Activity;)V
    ...
    iget-object v0, p0, Lkwyopc/kouubfr/sn8;->OooO0OO:Ljava/util/LinkedHashMap;
    ...
    :cond_1
    iget-object p1, p0, Lkwyopc/kouubfr/sn8;->OooO0o0:Lkwyopc/kouubfr/gd5;

    if-eqz p1, :cond_2

    invoke-virtual {p0, p2}, Lkwyopc/kouubfr/sn8;->OooO00o(Landroid/app/Activity;)Lkwyopc/kouubfr/xoa;

    move-result-object v0

    invoke-virtual {p1, p2, v0}, Lkwyopc/kouubfr/gd5;->Oooo00o(Landroid/app/Activity;Lkwyopc/kouubfr/xoa;)V
    ...
    instance-of v0, p2, Lkwyopc/kouubfr/pa6;

    if-eqz v0, :cond_3

    new-instance v0, Lkwyopc/kouubfr/pn8;

    invoke-direct {v0, p0, p2}, Lkwyopc/kouubfr/pn8;-><init>(Lkwyopc/kouubfr/sn8;Landroid/app/Activity;)V

    invoke-interface {p1, p2, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    check-cast p2, Lkwyopc/kouubfr/pa6;

    invoke-interface {p2, v0}, Lkwyopc/kouubfr/pa6;->OooO0o0(Lkwyopc/kouubfr/pl1;)V

    :cond_3
    return-void
.end method

.method public final OooO0Oo(Lkwyopc/kouubfr/ek7;)V
    .locals 3

    new-instance v0, Lkwyopc/kouubfr/gd5;

    invoke-direct {v0, p1}, Lkwyopc/kouubfr/gd5;-><init>(Lkwyopc/kouubfr/ek7;)V

    iput-object v0, p0, Lkwyopc/kouubfr/sn8;->OooO0o0:Lkwyopc/kouubfr/gd5;
    ...
    invoke-direct {v1, p0}, Landroidx/window/layout/adapter/sidecar/SidecarCompat$TranslatingCallback;-><init>(Lkwyopc/kouubfr/sn8;)V

    check-cast v1, Landroidx/window/sidecar/SidecarInterface$SidecarCallback;

    iget-object v2, p0, Lkwyopc/kouubfr/sn8;->OooO0O0:Lkwyopc/kouubfr/on8;

    invoke-direct {v0, v2, v1}, Landroidx/window/layout/adapter/sidecar/DistinctElementSidecarCallback;-><init>(Lkwyopc/kouubfr/on8;Landroidx/window/sidecar/SidecarInterface$SidecarCallback;)V
...
.method public final OooO0o0()Z
    ...
    :try_start_0
    iget-object v4, p0, Lkwyopc/kouubfr/sn8;->OooO00o:Landroidx/window/sidecar/SidecarInterface;
    ...
    iget-object v3, p0, Lkwyopc/kouubfr/sn8;->OooO00o:Landroidx/window/sidecar/SidecarInterface;
