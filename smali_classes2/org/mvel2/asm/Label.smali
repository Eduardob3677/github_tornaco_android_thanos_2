...
.method public final addLineNumber(I)V
    ...
    iget-short v0, p0, Lorg/mvel2/asm/Label;->lineNumber:S
...
.method public final addSubroutineRetSuccessors(Lorg/mvel2/asm/Label;)V
    ...
    iget-object v2, v0, Lorg/mvel2/asm/Label;->nextListElement:Lorg/mvel2/asm/Label;

    iput-object v1, v0, Lorg/mvel2/asm/Label;->nextListElement:Lorg/mvel2/asm/Label;
    ...
    iget-short v1, v0, Lorg/mvel2/asm/Label;->subroutineId:S

    iget-short v3, p1, Lorg/mvel2/asm/Label;->subroutineId:S

    if-eq v1, v3, :cond_0

    new-instance v1, Lorg/mvel2/asm/Edge;

    iget-short v3, v0, Lorg/mvel2/asm/Label;->outputStackSize:S

    iget-object v4, p1, Lorg/mvel2/asm/Label;->outgoingEdges:Lorg/mvel2/asm/Edge;

    iget-object v4, v4, Lorg/mvel2/asm/Edge;->successor:Lorg/mvel2/asm/Label;

    iget-object v5, v0, Lorg/mvel2/asm/Label;->outgoingEdges:Lorg/mvel2/asm/Edge;

    invoke-direct {v1, v3, v4, v5}, Lorg/mvel2/asm/Edge;-><init>(ILorg/mvel2/asm/Label;Lorg/mvel2/asm/Edge;)V

    iput-object v1, v0, Lorg/mvel2/asm/Label;->outgoingEdges:Lorg/mvel2/asm/Edge;

    :cond_0
    invoke-direct {v0, v2}, Lorg/mvel2/asm/Label;->pushSuccessors(Lorg/mvel2/asm/Label;)Lorg/mvel2/asm/Label;
    ...
    :cond_1
    :goto_1
    sget-object p1, Lorg/mvel2/asm/Label;->EMPTY_LIST:Lorg/mvel2/asm/Label;

    if-eq v1, p1, :cond_2

    iget-object p1, v1, Lorg/mvel2/asm/Label;->nextListElement:Lorg/mvel2/asm/Label;

    const/4 v0, 0x0

    iput-object v0, v1, Lorg/mvel2/asm/Label;->nextListElement:Lorg/mvel2/asm/Label;
...
.method public final getCanonicalInstance()Lorg/mvel2/asm/Label;
    ...
    :cond_0
    iget-object v0, v0, Lorg/mvel2/asm/Frame;->owner:Lorg/mvel2/asm/Label;
...
.method public getOffset()I
    ...
    iget v0, p0, Lorg/mvel2/asm/Label;->bytecodeOffset:I
...
.method public final markSubroutine(S)V
    ...
    iget-object v1, v0, Lorg/mvel2/asm/Label;->nextListElement:Lorg/mvel2/asm/Label;

    const/4 v2, 0x0

    iput-object v2, v0, Lorg/mvel2/asm/Label;->nextListElement:Lorg/mvel2/asm/Label;

    iget-short v2, v0, Lorg/mvel2/asm/Label;->subroutineId:S

    if-nez v2, :cond_0

    iput-short p1, v0, Lorg/mvel2/asm/Label;->subroutineId:S

    invoke-direct {v0, v1}, Lorg/mvel2/asm/Label;->pushSuccessors(Lorg/mvel2/asm/Label;)Lorg/mvel2/asm/Label;
...
.method public final put(Lorg/mvel2/asm/ByteVector;IZ)V
    ...
    iget p3, p1, Lorg/mvel2/asm/ByteVector;->length:I

    const/high16 v1, 0x20000000

    invoke-direct {p0, p2, v1, p3}, Lorg/mvel2/asm/Label;->addForwardReference(III)V
    ...
    iget p3, p0, Lorg/mvel2/asm/Label;->bytecodeOffset:I

    sub-int/2addr p3, p2

    invoke-virtual {p1, p3}, Lorg/mvel2/asm/ByteVector;->putInt(I)Lorg/mvel2/asm/ByteVector;
